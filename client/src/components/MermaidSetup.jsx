    ...
    const renderDiagram = async () => {
      try {
        ...
        if (containerRef.current) {
          containerRef.current.innerHTML = `<div class="p-3 text-xs text-amber-700 bg-amber-50 rounded border border-amber-200">Unable to render diagram preview. View detailed notes text below.</div>`;
        }
      }
    };
